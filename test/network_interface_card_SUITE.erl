...
basic(_Config) ->
    ...
    ok = wire:connect({network_interface_card, NicOnePid}, WirePid),
    ok = wire:connect({network_interface_card, NicTwoPid}, WirePid),
    ok = wire:send({network_interface_card, NicOnePid}, WirePid, ~"hello world"),
